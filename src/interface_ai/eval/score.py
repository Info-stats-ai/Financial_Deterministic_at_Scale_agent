...
def score_trials(
    ...
    *,
    ...
    missing = [item for item in trials if item.scenario == "not_found"]
    ...
    policy_denials = sum(item.policy_denied for item in trials)
    ...
    gates = {
        ...
        "no_policy_denials": policy_denials == 0,
    }
    ...
    metrics = {
        ...
        "policy_denials": float(policy_denials),
        "composite": composite,
